...
import { mbAttachCustomers, mbBuildRoomList, mbConfigured, mbFetchCustomers, mbFetchOperationalBookings, mbFetchRoomMapping, mbProbeHousekeeping } from "../_shared/misterbooking.ts";
