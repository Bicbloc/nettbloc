...
CREATE TRIGGER update_housekeeper_access_codes_updated_at
BEFORE UPDATE ON public.housekeeper_access_codes
...
-- Mettre à jour les hôtels sans code
UPDATE public.hotels 
SET hotel_code = 'HTL' || LPAD((ROW_NUMBER() OVER (ORDER BY created_at))::TEXT, 3, '0')
