...
BEGIN
    ...
    IF hotel_uuid IS NOT NULL THEN
        ...
        -- Créer les codes d'accès correspondants pour chaque femme de chambre
        FOR housekeeper_id IN 
            SELECT id FROM public.housekeepers WHERE hotel_id = hotel_uuid
        LOOP
