-- Update can_access_hotel to also check housekeeper_access_requests (not just hotel_access_sessions)
...
BEGIN
  RETURN 
    ...
    OR
    -- User is a governess with approved access request
    EXISTS (
    ...
    OR
    -- User is a housekeeper with approved access request
    EXISTS (
