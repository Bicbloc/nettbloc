...
BEGIN
    ...
    IF hotel_uuid IS NOT NULL THEN
        ...
        -- Ajouter quelques femmes de chambre d'exemple
        INSERT INTO public.housekeepers (hotel_id, name, access_code, user_id, is_active)
        VALUES 
            (hotel_uuid, 'Marie Dupont', 'HTL015-MAR-1234', user_uuid, true),
            (hotel_uuid, 'Sophie Martin', 'HTL015-SOP-5678', user_uuid, true),
            (hotel_uuid, 'Julie Bernard', 'HTL015-JUL-9012', user_uuid, true)
