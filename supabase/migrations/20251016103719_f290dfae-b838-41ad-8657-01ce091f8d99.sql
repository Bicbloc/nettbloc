-- Fix generate_and_insert_access_code function to handle conflicts properly
CREATE OR REPLACE FUNCTION public.generate_and_insert_access_code(p_hotel_id uuid, p_housekeeper_name text)
 RETURNS text
 LANGUAGE plpgsql
 SECURITY DEFINER
...
BEGIN
  ...
  -- Insérer dans housekeeper_access_codes (sans ON CONFLICT)
