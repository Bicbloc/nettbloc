  ...
  return (
    <div className="flex flex-col items-center">
      <a href="https://www.bicbloc.eu" target="_blank" rel="noopener noreferrer" className="block max-w-[400px] mx-auto">
        <img 
          src={`${window.location.origin}/lovable-uploads/fab4ce53-a146-478a-a585-fab338cb0095.png`}
          alt="BicBloc Logo"
      ...
      >
        <div className="max-w-full w-full">
          <AspectRatio ratio={16/4} className="w-full">
            <img 
              src={`${window.location.origin}/lovable-uploads/c8c4ab5d-01f9-48ea-970c-2ba1488f614d.png`}
              alt="BicBloc Banner"
