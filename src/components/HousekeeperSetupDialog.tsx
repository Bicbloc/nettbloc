...
import { UnifiedHousekeeperService } from '@/services/unifiedHousekeeperService';
...
export function HousekeeperSetupDialog({
  ...
  const loadExistingHousekeepers = async () => {
    ...
    try {
      const housekeepersWithCodes = await UnifiedHousekeeperService.getCodesForHotel(hotelId);
                            ...
                            {housekeeper.access_code && (
                              <div className="flex items-center gap-2 mt-2">
                                ...
                                <Button
                                  ...
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    UnifiedHousekeeperService.copyToClipboard(housekeeper.access_code!);
                                  }}
                                  className="p-1 h-6 w-6"
                                >
