...
import { Mail, Lock, ArrowLeft, Loader2, LogIn, UserPlus } from 'lucide-react';
...
export default function HousekeeperAuth() {
  ...
  const checkUser = async () => {
    ...
    if (session?.user) {
      // Vérifier si c'est un profil femme de chambre
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="text-center pt-4 border-t">
              <p className="text-sm text-muted-foreground mb-3">
                Ou accédez avec un code d'accès temporaire
              </p>
              <Button
                variant="ghost"
                size="sm"
